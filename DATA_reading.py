    ...
    with fits.open(filename, memmap=False) as fichier:
        ...
        for i in range(len(index_t3)):
            ...
            if len_wavel_t3 == max(wavel_shape):
                ...
                u3_coord = np.append(u3_coord,u1_coord+u2_coord)
                v3_coord = np.append(v3_coord,v1_coord+v2_coord)
...
#filename = 'C:/Users/jdrevon/Desktop/VLTI Observations/pi01Gru/LM/4_DATA_SORTED_FLUX_CAL_MEAN_QC/LM_ALL_4.03_4.17.fits'
